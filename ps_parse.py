...
def p_Import(t):
   ...
   location = t[4]
   profile = t[5]
   t[0] = node('Import', location=iri(location), profile=profile)
...
def p_Group(t):
   ...
   t[0] = node('Group', annotation=t[1], sentence=t[4])

def p_RULE_1(t):
   '''RULE      : IRIMETA_opt KW_Forall Var_plus LPAREN CLAUSE RPAREN'''
   t[0] = node('Forall', annotation=t[1], declare=t[3], formula=t[5])
...
def p_FORMULA_1(t):
   ...
   t[0] = node('And', annotation=t[1], formula=t[4])
def p_FORMULA_2(t):
   '''FORMULA        :  IRIMETA_opt KW_Or LPAREN FORMULA_star RPAREN'''
   t[0] = node('Or', annotation=t[1], formula=t[4])
def p_FORMULA_3(t):
   '''FORMULA        :  IRIMETA_opt KW_Exists Var_plus LPAREN FORMULA RPAREN'''
   t[0] = node('Exists', annotation=t[1], declare=t[3], formula=t[5])
def p_FORMULA_4(t):
   '''FORMULA        :  ATOMIC'''
   t[0] = t[1]
def p_FORMULA_5(t):
   '''FORMULA        :  IRIMETA_opt KW_External LPAREN Atom RPAREN'''
   t[0] = node('ExternalAtom', annotation=t[1], content=t[4])
...
def p_Atom_2(t):
   ...
   t[0] = node('NamedArgsAtom', op=t[1], slot=t[3])
...
def p_Equal(t):
   ...
   t[0] = node('Equal', left=t[1], right=t[3])


def p_Member(t):
   '''Member         : TERM HASH TERM '''
   t[0] = node('Member', instance=t[1], class_=t[3])
...
def p_Frame(t):
   ...
   t[0] = node('Frame', object=t[1], slot=t[3])
...
def p_TERM_2(t):
   ...
   t[0] = node('ExternalExpr', annotation=t[1], content=t[4])
...
def p_Expr_2(t):
   ...
   t[0] = node('NamedArgsExpr', op=t[1], slot=t[3])
...
def p_IRIMETA_opt_2(t):
   ...
   t[0] = node('Annotation', iri=t[2], sentence=None)
def p_IRIMETA_opt_3(t):
   '''IRIMETA_opt     : LMETA IRICONST KW_And LPAREN Frame_star RPAREN RMETA '''
   t[0] = node('Annotation', iri=t[2], sentence=node('And', formula=t[5]))
...
def p_IRIMETA_opt_4(t):
   ...
   t[0] = node('Annotation', sentence=node('Frame', object=t[2], slot=t[4]))
...
def p_IRIMETA_opt_6(t):
   ...
   t[0] = node('Annotation', iri=t[2], sentence=node('Frame', object=t[3], slot=t[5]))
...
def p_TERM_arrow_TERM(t):
   ...
   t[0] = node('Slot', key=t[1], value=t[3])
