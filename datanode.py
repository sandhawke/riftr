...
class Instance(nc.Instance):
    ...
    def __setattr__(self, prop, value):
        ...
        self.dict.setdefault(prop, self.factory.Multi()).add(value)
    ...
    def __getattr__(self, prop):
        ...
        return self.dict.setdefault(prop, self.factory.Multi())
    
    def __getstate__(self):
        return (self.factory, self.nsmap, self.dict)

    def __setstate__(self, state):
        object.__setattr__(self, "factory", state[0])
        object.__setattr__(self, "nsmap", state[1])
        object.__setattr__(self, "dict", state[2])
